...
async def cmd_ranks_help(message: Message, **kw):
    perms = {
        1: "мут, кик, варн, удаление сообщений, созыв · понижение после 2 варнов",
        2: "бан, чистка, теги, розыгрыши, триггеры, −реп · после 3 варнов",
        3: "правила, приветствие, награды, лимит варнов · после 4 варнов",
        4: "доступ команд, автокик, антиспам, сетка · после 5 варнов",
        5: "снять всех, сброс настроек, полный контроль чата · после 6 варнов",
        6: "технический доступ, история наказаний · иммунитет к варнам",
        7: "заместитель лидера: почти все права · иммунитет к варнам",
        8: "высший ранг: все команды, неприкосновенность и иммунитет",
    }
