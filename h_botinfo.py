...
UPDATE_TEXT = (
    "🎁 <b>Обновление бота — 20 сентября</b>\n\n"
    "✅ 💍 <b>Полноценная система отношений (ОТН)</b>: прокачка 1-8 уровней, 15 романтических действий с таймерами, механика обиды и задабривания (1-15 очков до 100), покупка совместного имущества (квартиры, дома, яхты, заводы) и воспитание детей в меню <code>отн меню</code>!\n"
    "✅ 💎 <b>Ранги VIP и VIP+</b>: повышенные бонусы к доходу на работе (+50% и +100%) и очкам любви в отношениях, статус в профиле и интерактивное <code>вип меню</code> с выбором цветовых тем оформления!\n"
    "✅ 🎰 <b>Заработок ирисок</b>: команда <code>работа</code> теперь закреплена строго в теме Казино, чтобы не засорять основной чат!\n"
    "✅ 🛡 <b>Модерация и порядок</b>: полное логирование всех мутов, банов и варнов; при бане нарушителя автоматически очищается его анкета и ник!\n"
    "✅ 👤 <b>Исправлена карточка профиля</b>: семейное положение теперь отображает реальные отношения пары, а <code>кто ты</code> показывает карточку любого участника!\n\n"
