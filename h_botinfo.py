...
UPDATE_TEXT = (
    ...
    "✅ 📊 <b>Подсчет сообщений и активность</b>: новая команда <code>сообщения [юзер]</code> (а также <code>смс</code>, <code>актив</code>) — подробная статистика сообщений в группе (сегодня, 7 дней, 30 дней, всё время, % от общего чата и место в топе)!\n"
    "✅ 💤 <b>Массовые варны неактиву</b>: команда <code>варн неактив [срок]</code> выдает предупреждение на 30 дней от имени <b>Кузя</b> всем неактивным участникам (с возможностью обжалования у администрации)!\n"
    "✅ 🎨 <b>Эксклюзивность VIP+</b>: меню выбора тем и цветовых стилей оформления сообщений теперь эксклюзивно доступно только владельцам статуса 🌟 VIP+ (<code>вип+ команды</code>)!\n"
    "✅ 🛡 <b>Полномочия Тех. Администратора</b>: полный и неограниченный доступ ко всем командам модерации (кик, бан, мут, варны, чистка, история) для 6 ранга!\n"
    "✅ 👑 <b>Фиксация рангов</b>: любые автоповышения отключены — ранги выдаются строго администрацией вручную!\n"
    "✅ 💍 <b>Мульти-отношения и друзья</b>: поддержка нескольких браков, комплименты (<code>комплимент</code> начисляет +5 любви сразу всем партнерам) и дружба (<code>друг @юзер</code>) без ограничений!\n"
    "✅ 🎲 <b>Казино и ограбления</b>: команда <code>казик [ставка]</code> с мини-играми (кости, слоты, дартс, баскетбол) и <code>украсть @юзер [сумма]</code>!\n\n"
...
async def announce_update_on_startup(bot: Bot) -> None:
    ...
    marker = "update_announced_26_09_2026_sms_v6"
